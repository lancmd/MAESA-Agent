---
name: mining-area-ecological-analysis
description: 面向全国矿区，在本机完成多期土地利用分类、PLUS 情景预测、InVEST 生态系统服务评价、论文制图与受控成果归档；适用于用户提供本地项目数据并要求检查、运行、续跑或整理成果的任务。
---
...
2. 只运行编译得到的工作流，并保留 `workflow_state.json`、`outputs_manifest.json`、`provenance.json` 和 `validation_summary.json`。

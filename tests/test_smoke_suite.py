...
@pytest.mark.parametrize("script", [
    "project_conditional_inputs_smoke.py", "project_builder_smoke.py", "classification_invest_smoke.py", "sensor_profile_workflow_smoke.py", "chronological_lulc_history_smoke.py", "full_chain_builder_contract_smoke.py", "project_workflow_smoke.py", "plus_re_contract_smoke.py",
    ...
    "invest_datastack_builder_smoke.py", "invest_parameter_report_smoke.py",
    "invest_mcp_builder_smoke.py",
    "habitat_datastack_workflow_smoke.py",
    "multiperiod_invest_summary_smoke.py",
    ...
    "workflow_manifest_safety_smoke.py", "job_manager_smoke.py", "reliability_contract_smoke.py", "local_only_registry_smoke.py", "status_vocabulary_smoke.py", "startup_scripts_smoke.py", "release_metadata_smoke.py",
